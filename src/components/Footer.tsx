...
import Technosphere from "../assets/Technosphere.svg"
  ...
  return (
    <div className="footer">
      <div className="footerPadding">
        <Grid container direction="row" justifyContent="space-between" alignItems="stretch" className="footerBottomMargin">
      ...
      <div className="copyright CopyrightPadding">
