...
const HeroSection: React.FC<{}> = () => {
  return (
    <>
      <div className="Hero">
        <div className="Event_date">NoV 28 - Dec 2</div>
        ...
        <div>
          <button className="register_btn_hero" onClick={handleClick}>
            REGISTER NOW <img src={arrow} alt="arrow" className="right_arrow" />
          </button>
        </div>
      </div>
